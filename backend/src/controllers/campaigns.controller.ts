...
export async function list(req: AuthRequest, res: Response) {
  ...
  res.json(await campaignService.listCampaigns(page, limit));
}
...
export async function get(req: AuthRequest, res: Response) {
  res.json(await campaignService.getCampaign(Number(req.params.id)));
}

export async function update(req: AuthRequest, res: Response) {
  res.json(await campaignService.updateCampaign(Number(req.params.id), req.body));
}
...
export async function send(req: AuthRequest, res: Response) {
  res.json(await campaignService.sendCampaign(Number(req.params.id)));
}

export async function stats(req: AuthRequest, res: Response) {
  res.json(await campaignService.getCampaignStats(Number(req.params.id)));
}
